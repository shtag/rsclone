...
export class HeaderView {
    ...
    static async renderHeaderAfterLogin() {
       ...
       <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="profile-btn route" href="/${(await user).username}"></a>
        <input class="theme" type="checkbox">
            `;
    ...
    static renderNavBar() {
        ...
        <a href="/recommendation" class="recomendation-btn route"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
