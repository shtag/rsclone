...
class AddPostView {
    static renderAddPost() {
        ...
        <div class="add__block">
          ...
          <button class="add__filter">Filter</button>


              <button class="add__delete open__post-btn"><div class="text_button">Delete image</div></button>
              ...
              <button class="add__post open__post-btn" disabled><div class="text_button">Create post</div></button>
            </form>
          </div>   
        </div>   
        `;
